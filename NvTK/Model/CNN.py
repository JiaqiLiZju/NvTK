...
class CNN(BasicModel):
    ...
    def __init__(self, output_size, 
        ...
        self.Encoder = nn.Sequential(BasicConv1d(in_planes=128, out_planes=256),
                        nn.AdaptiveAvgPool1d(8),
                        Flatten())
        self.Decoder = BasicLinearModule(256 * 8, output_size)
        self.Predictor = BaiscPredictor(tasktype=tasktype)
